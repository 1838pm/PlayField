                ...
                <ul class="navbar-nav navbar-nav-hover justify-content-center">
                            ...
                            <div class="col-auto px-0">
                                <div class="list-group list-group-flush">
                                    <a href="${path}/search/searchList" class="list-group-item list-group-item-action d-flex align-items-center p-0 py-3 px-lg-4">
                                        ...
                                        <div class="ml-4">
                                            <span class="text-dark d-block">구장조회<span class="badge badge-sm badge-secondary ml-2"></span></span>
                                        </div>
                                    </a>
                                    <a href="${path}" class="list-group-item list-group-item-action d-flex align-items-center p-0 py-3 px-lg-4">
                                        <span class="icon icon-md icon-primary"><i
                                                class="fas fa-microphone-alt"></i></span>
                                        <div class="ml-4">
                                            <span class="text-dark d-block">준비중</span>
                                        </div>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="dropdown-menu dropdown-menu-lg" aria-labelledby="supportDropdown">
                            <div class="col-auto px-0">
                                <div class="list-group list-group-flush">
                                    ...
                                    <a href="${path}/match/matchView" class="list-group-item list-group-item-action d-flex align-items-center p-0 py-3 px-lg-4">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg" aria-labelledby="supportDropdown">
                            <div class="col-auto px-0">
                                <div class="list-group list-group-flush">
                                    <a href="${path}/board_trade/tradeList" class="list-group-item list-group-item-action d-flex align-items-center p-0 py-3 px-lg-4">
                                        <span class="icon icon-md icon-secondary"><i class="fas fa-file-alt"></i></span>
                                        <div class="ml-4">
                                            <span class="text-dark d-block">중고거래 게시판<span class="badge badge-sm badge-secondary ml-2"></span></span>
                                        </div>
                                    </a>
        ...
        <div class="contain">
            ...
            <div class="sport">
                ...
                <div class="soccer" style="position: absolute; top: 65%; left: 17%;">
                    <a href="${path}/search/searchList"><img style="opacity: 0.75; border-radius: 8%;" src="${path}/resources/img/구장조희_1.jpeg" alt=""></a>
                    <a href="${path}/search/searchList"><span style="color: rgba(255,255,255,.80);"><br><br>구장조회</span></a>
                </div>
                
                <div class="fotsal" style="position: absolute; top: 65%; left: 42%;">
                    <a href="${path}/match/matchList"><img style="opacity: 0.75; border-radius: 8%;" src="${path}/resources/img/소셜매치_1.jpg" alt=""></a>
                    <a href="${path}/match/matchList"><span style=" color: rgba(255,255,255,.80); "><br><br>소셜매치</span></a>
                </div>        
                
                <div class="basketball" style="position: absolute; top: 65%; left: 67%;">
                    <a href="${path}/board/boardList"><img style="opacity: 0.75; border-radius: 8%;" src="${path}/resources/img/커뮤니티_1.jpg" alt=""></a>
                    <a href="${path}/board/boardList"><span style=" color: rgba(255,255,255,.80);"><br><br>커뮤니티</span></a>
                </div>
            </div>
        </div>
