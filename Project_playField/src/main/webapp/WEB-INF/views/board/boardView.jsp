...
<body>
    <section class="section-header section-images bg-primary text-white pb-9 pb-lg-12 mb-4 mb-lg-6 overlay-primary" data-background="${path}/resources/img/Soccer-ball.jpg"></section>
    <section class="section section-lg pt-0">
        <div class="container mt-n8 mt-lg-n12 z-2">
            <div class="row justify-content-center">
                <div class="col">
                    <div class="card border-light p-4 p-lg-5">
                        <h1 class="h3 mb-4" style="height: 100px;">첫 번째 게시글</h1>
                        <p class="lead">내용 시작<br><br><br><br><br><br><br><br><br><br><br><br><br><br>내용 끝</p>
            
                        <div class="text-center border-top border-bottom border-light my-6 py-6">
                            <button type="button" class="btn btn-success mr-sm-3 animate-up-2"><span class="mr-2"><i class="far fa-thumbs-up"></i></span>좋아요</button>
                            <button type="button" class="btn btn-danger animate-down-2"><span class="mr-2"><i class="far fa-thumbs-down"></i></span>싫어요</button>
                        </div>
                    </div>
                </div>
            </div>
