            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="signin-inner mt-3 mt-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <form name="SignInForm" action="${path}/member/signIn" method="post">
                            <!-- Form -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" name="pwd" id="pwd" placeholder="Password" type="password" required>
                                    </div>
                                </div>
                                <!-- End of Form -->
                            ...
                            <button type="submit" id="submit" name="submit" class="btn btn-block btn-primary">로그인</button>
                        </form>
                        <!-- 로그인 아이콘  -->
